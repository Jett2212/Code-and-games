...
if (BoxCollider != nullptr)
{
	...
	BoxCollider->OnComponentHit.AddDynamic(this, &ASword::OnCollision);
}
}
...
void ASword::OnCollision(UPrimitiveComponent *HitComp, AActor *OtherActor, UPrimitiveComponent *OtherComp, FVector NormalImpulse, const FHitResult &Hit)
{	
